		...
		<form action="regprocess.php" method="POST" id="registracija"> 
			...
			<h1>Registracija</h1>
                        <div class="form-input">
                            ...
                            <input style="margin-top:0;" name="username" type="text" id="ki" placeholder="Nuxaa123" autocomplete="off" />
                        </div>
                        <div class="form-input">
                            <label>Ime i prezime</label>
                            <input style="margin-top:0;" name="ime" type="text" id="ki" placeholder="Mirza Hrvanovic" autocomplete="off" />
                        </div>
                        <div class="form-input">
                            <label>E-mail</label>
                            <input name="email" type="text" id="email" placeholder="mirza@e-west.eu" autocomplete="off" />
                        </div>
                        <div class="form-input">
