...
function izracunajCenu(){
	...
	var cena_valuta_zemlja = Cena+" "+Valuta+" <span style='float: right; margin-top: 8px; margin-right: 8px;'><img src='./assets/orange/img/"+flag+".png' /></span>";
...
console.log('Designed by: Mirza Hrvanovic');
