...
switch (@$task)
{
	...
	case 'klijent_add':
		...
		$message =
			...
			Nedavno Vam je admin registrovao nalog na <b>E-West Hosting</b>.<br />
			<br /><br />
			...
			Vas <b>E-West Hosting!</b>";
				
				
		###
		$headers  = 'MIME-Version: 1.0' . "\r\n";
		$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
		$headers .= 'From: E-West Hosting <podrska@'.$_SERVER['SERVER_NAME'].'>' . "\r\n";
	...
	case 'emailbug':
		...
		$headers  = 'MIME-Version: 1.0' . "\r\n";
		$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
		$headers .= 'From: E-West Hosting <localhost@'.$_SERVER['SERVER_NAME'].'>' . "\r\n";
		$headers .= 'X-Mailer: PHP/' . phpversion();
		#-----------------+
		$mail = mail($to, $subject, $message, $headers);
		#-----------------+
	...
	case 'izbrisi-srv':
		...
		require_once("/home/admin/web/ewest-hosting.info/public_html/includes/func.server.inc.php");
	...
	case 'mailtoall':
		...
		$headers  = 'MIME-Version: 1.0' . "\r\n";
		$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
		$headers .= 'From: E-West Hosting <mail@'.$_SERVER['SERVER_NAME'].'>' . "\r\n";
		$headers .= 'X-Mailer: PHP/' . phpversion();
		#-----------------+
