		...
		<div class="extra-inner">
			<div class="container">
				<div class="row">
					<div class="span12">
						<center>
							<img src="<?php echo $dir ?>/assets/img/icon/" alt="e-West Hosting!">
						</center>
					</div>
				</div>
			</div>
...
<div class="footer">
		<div class="footer-inner">
			<div class="container">
				<div class="row">
					<div class="span12"> © 2017 - 2018 <a href="#">e-West Hosting</a> </div>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal-body">
		<form action="process.php" method="post" id="validation-form" enctype="multipart/form-data">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input name="datacentar" class="span5" type="text" placeholder="DATACENTAR #1">
				</div>
			</div>	
...
<div id="dodaj-slajd" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="label" aria-hidden="true">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
		<h3 id="label">Dodaj vest</h3>
	</div>
	<div class="modal-body">
		<form action="process.php" method="post" enctype="multipart/form-data">
			<input type="hidden" name="task" value="dodaj_vest" />
			<div class="control-group">
				<label for="naslov">Naslov</label>
				<div class="controls">
...
<div id="edit_vest" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="label" aria-hidden="true">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
		<h3 id="label">Edit vest</h3>
	</div>
	<div class="modal-body">
		<form action="process.php" method="post" enctype="multipart/form-data">
			<input type="hidden" name="task" value="edit_vest" />
			...
			<div class="control-group">
				<label for="tekst">Text</label>
				<div class="controls">
					<textarea id="texts" rows="5" name="poruka" class="span5" type="text" value=""></textarea>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input id="l_slika" name="l_slika" class="span5" type="text" value="">
				</div>
			</div>
...
<div id="modedit" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="label" aria-hidden="true">
	...
	<script src="http://e-trail.eu/assets/blue/js/autosize.js"></script>
