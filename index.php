...
?>
	<div class="home">
	    ...
	    <div class="home-links">
	    	<ul>
	    		<a target="_blank" href="http://fb.com/ewesthost"><li><i class="fab fa-facebook-f"></i></li></a>
		...
		<ul>
			...
			<li>
				<div class="home-services-padding">
				    <div class="home-services-content">
				        <div class="img">
					        <img src="assets/img/cod-banner.png">
					        <h1>COD 2</h1>
				        </div>
			...
			<li>
				<div class="home-services-padding">
				    <div class="home-services-content">
				        <div class="img">
					        <img src="assets/img/cod4-banner.png">
					        <h1>COD 4</h1>
				        </div>
			...
			<li>
				<div class="home-services-padding">
				    <div class="home-services-content">
				        <div class="img" style="background: #e53b3b;">
				        ...
				        <h4>N/A<font class="font-16px">/slot</font></h4><button style="background: #e53b3b;">Uskoro</button>
			        </div>
			    </div>
			</li>
			<li>
				<div class="home-services-padding">
				    <div class="home-services-content">
				        <div class="img">
					        <img src="assets/img/csgo-banner.png">
					        <h1>CS GO</h1>
				        </div>
	...
	<div class="home-features">
		<ul>
			...
			<li>
			    ...
			    <p>e-West koristi kvalitetne servere velikog kapaciteta</p>
		    </li>
			<li>
			    <div class="title">
